...
public class RandomArrayGenerator {
	 ...
	 * node as both start and end points.
	 * 
	 * @param prefix
	 * @param nodeSize
	 * @param edgeSize
	 ...
	 * @return
	 */
	public static Graph<String> getRandGraph(String prefix, int nodeSize,
			int edgeSize, boolean connected) {
		...
		int[] weight = getRandIntArray(edgeSize, 1, 10);
		...
		if (connected) {
			for (int i = 0; i < nodeSize - 1; i++) {
				graph.addEdge(nodes[i], nodes[i + 1], 2);
			}
		}
